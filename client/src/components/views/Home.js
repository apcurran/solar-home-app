            ...
            <div className="home">
                ...
                <main className="home__main">
                    <section className="home__main__sect">
                        <div className="home__main__sect__inner-sect--left">
                        ...
                        <div className="home__main__sect__inner-sect--right">
                            <figure className="home__main__sect__inner-sect--right__fig">
                                <img  className="home__main__sect__inner-sect--right__fig__img" src="https://res.cloudinary.com/dev-project/image/upload/f_auto,q_auto/v1616083916/aperture-solar/house-solar-panels_szr0wk.jpg" alt="Two-story house with solar panels on the roof."/>
                            </figure>
                        </div>
                    </section>
                </main>
